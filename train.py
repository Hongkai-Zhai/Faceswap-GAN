...
from p_loss.perceptual_loss import calculate_perceptual_loss
def str2bool(v):
...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_per', type=float, default=0.1, help='weight for perceptual loss')
    ...
    for step in range(start, total_step):
        ...
        for interval in range(2):
            ...
            if interval:
                ...
                loss_perceptual = calculate_perceptual_loss(img_fake, src_image1)
                loss_G          = loss_Gmain + loss_G_ID * opt.lambda_id + feat_match_loss * opt.lambda_feat + opt.lambda_per *loss_perceptual
